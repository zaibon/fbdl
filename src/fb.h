...
#define QUERY_ALBUM "SELECT aid,name,photo_count,owner FROM album WHERE owner IN (select uid from user WHERE username = '%s') OR owner IN (SELECT page_id FROM page WHERE name = '%s')"
